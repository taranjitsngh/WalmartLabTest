...
class WMProductModelTest: XCTestCase {
    ...
    func testEmptyJson() {
        let newModel = WMProductModel(json: [:])
    ...
    func testInvalidJson() {
        ...
        let newModel = WMProductModel(json: testData)
        XCTAssertNil(newModel)
    }
    ...
    func testInStockExtention() {
        let testJson = "{\"productId\": \"0150f9b5-8918-4fd1-92b3-fc032cc6c684\",\"productName\": \"Samsung Ultra HD LED Smart\",\"shortDescription\": \"Resolution: 4K Ultra HD\",\"longDescription\": \"With 4K UHD resolution.\",\"price\": \"$928.00\",\"productImage\": \"https://walmartlabs-test.appspot.com/images/image5.jpeg\",\"reviewRating\": 4.5,\"reviewCount\": 2,\"inStock\": true}"
        ...
        let newModel = WMProductModel(json: testData)
        XCTAssertEqual(newModel?.stockStatus(), NSLocalizedString("In stock", comment: ""))
    }
    
    func testOutOfStockExtention() {
        let testJson = "{\"productId\": \"0150f9b5-8918-4fd1-92b3-fc032cc6c684\",\"productName\": \"Samsung Ultra HD LED Smart\",\"shortDescription\": \"Resolution: 4K Ultra HD\",\"longDescription\": \"With 4K UHD resolution.\",\"price\": \"$928.00\",\"productImage\": \"https://walmartlabs-test.appspot.com/images/image5.jpeg\",\"reviewRating\": 4.5,\"reviewCount\": 2,\"inStock\": false}"
        ...
        let newModel = WMProductModel(json: testData)
        XCTAssertEqual(newModel?.stockStatus(), NSLocalizedString("Not in stock", comment: ""))
    }
    ...
    func testRatingText() {
        ...
        let newModel = WMProductModel(json: testData)
        XCTAssertEqual(newModel?.ratingText(), "4.5")
    }
    
    func testReviewCountText() {
        let testJson = "{\"productId\": \"0150f9b5-8918-4fd1-92b3-fc032cc6c684\",\"productName\": \"Samsung Ultra HD LED Smart\",\"shortDescription\": \"Resolution: 4K Ultra HD\",\"longDescription\": \"With 4K UHD resolution.\",\"price\": \"$928.00\",\"productImage\": \"https://walmartlabs-test.appspot.com/images/image5.jpeg\",\"reviewRating\": 4.5,\"reviewCount\": 2,\"inStock\": false}"
        ...
        let newModel = WMProductModel(json: testData)
       XCTAssertEqual(newModel?.reviewCountText(), "(2)")
    }
